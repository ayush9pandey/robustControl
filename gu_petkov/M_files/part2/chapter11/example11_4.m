% Example 11.4
%
% H_infinity design of 2-dof controller for the mass/damper/spring system
%
s = tf('s');
%
...
sigma(1/Wu,'r-',KSo64,'b--',omega)
grid
title('Input sensitivity of the uncertain system')
legend('1/Wu','K*So',3)
%
% Transient response of the nominal system
tfin = 20;   % final time
...
nstep = size(time,1);
dist(1:nstep) = 0.0;
[y,t] = lsim(cls.Nominal(1:2,1:2),[ref,dist'],time);
figure(8)
